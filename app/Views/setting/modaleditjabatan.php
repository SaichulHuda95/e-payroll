    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="modaleditjabatanLabel">Edit Jabatan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open('pengaturan/update_jabatan') ?>
            <div class="modal-body">
                <div class="form-group">
                    <label for="exampleFormControlInput1">Nama Jabatan</label>
                    <input type="hidden" name="id_jabatan" value="<?= $id_jabatan ?>">
                    <input type="text" class="form-control" name="jabatan" placeholder="Nama Jabatan" value="<?= $jabatan ?>" required>
                </div>
            </div>
