<div class="modal fade" id="modaleditnwnp" tabindex="-1" aria-labelledby="modaleditnwnpLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="modaleditnwnpLabel">Tambah NWNP</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('nwnp/update_nwnp') ?>/<?= $id_nwnp; ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tanggal_absen" id="tanggal_absen" value="<?= $tanggal_absen; ?>">
                            </div>
                            <div class="form-group">
